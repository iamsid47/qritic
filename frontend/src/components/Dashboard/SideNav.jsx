          ...
          <ul className="space-y-2 font-medium">
            ...
            {/* <li>
              ...
              >
                ...
                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full bg-blue-900 text-blue-300">
                  3
                </span>
              </a>
            </li> */}
            ...
            <div className="bottom-0">
              <p className="text-gray-400 py-4">Danger Zone</p>
              <li>
                <button
                  onClick={handleLogout}
                  className="flex w-full text-left items-center p-2  rounded-lg bg-red-700/40 text-white  hover:bg-red-700 group transition duration-300"
                >
                  <svg
                    className="flex-shrink-0 w-5 h-5  transition duration-75 text-gray-100  group-hover:text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 18 16"
