    ...
    <footer className=" lg:px-12 px-12 py-16 divide-y space-y-11 bg-[#111] text-gray-100 ">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 ">
        <div className="lg:w-1/3 py-5">
          ...
          >
            <h1 className="self-center text-4xl md:text-6xl font-semibold bg-sky-400 bg-clip-text text-transparent logo tracking-tight">
              Qritic
            </h1>
          </a>
          <div>
        ...
        <div className="grid grid-cols-3 text-base gap-x-3 gap-y-8 lg:w-1/3">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start space-x-3">
              ...
              <a
                href="https://www.producthunt.com/posts/qritic-resume-ranking-for-hr-nerds?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-qritic&#0045;resume&#0045;ranking&#0045;for&#0045;hr&#0045;nerds"
                target="_blank"
                rel="noreferrer"
              >
                <img
                  src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=420178&theme=light"
                  alt="Qritic&#0032;&#0045;&#0032;Resume&#0032;Ranking&#0032;for&#0032;HR&#0032;Nerds - Qritic&#0032;helps&#0032;you&#0032;filter&#0032;out&#0032;the&#0032;best&#0032;candidates&#0032;using&#0032;AI | Product Hunt"
                  style={divStyle}
                  width="250"
                  height="54"
                />
