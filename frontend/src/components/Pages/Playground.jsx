        ...
        <form action="#" className="py-12">
          <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm flex flex-col justify-center">
            <div class="relative w-full">
              ...
              <input
                class="block p-3 w-full text-sm  rounded border  focus:ring-primary-500 focus:border-primary-500 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500"
