...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${reqURL}/user/login`, {
        email: email,
        password: password,
      });
  ...
  return (
    <section className="">
      <Navbar />
      <div className="flex flex-col items-center min-h-screen justify-center px-6 py-8 mx-auto lg:py-0 bg-gray-900">
